...
Customization.multiLanguage = false;
...
Customization.hideOtherPropertyIfItemsInCart = true;
...
Customization.features.giftCertificates = false;			// true = feature enabled | false = feature not enabled
Customization.features.golfBooking = false;        // true = feature enabled | false = feature not enabled
Customization.features.diningBooking = false;				// true = feature enabled | false = feature not enabled
Customization.features.pmsBooking = true;				// true = feature enabled | false = feature not enabled
Customization.features.membership = false;				// true = feature enabled | false = feature not enabled
...
Customization.spaBooking.autoExpandResults = true;
Customization.spaBooking.showPriceIncludingSurcharges = false;
Customization.spaBooking.preserveClassItemCrossDate = false;
Customization.spaBooking.disallowBookForGroupMember = true;
Customization.spaBooking.disallowQuickAddGroupMember = true;
...
Customization.payment.requireExplicitTermsAccept = false;
Customization.payment.defaultStoreCard = true;
Customization.payment.skipCCifGuaranteed = true;
...
// Customization.SOAPUrl = 'https://reservations.miraval-austin.com/wso2wsas/services/RSWS.RSWSSOAP';
//Customization.SOAPUrl = 'https://192.168.0.177/wso2wsas/services/RSWS.RSWSSOAP';
