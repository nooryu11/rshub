...
Localization.general.continueProcessButtonLabel  = 'Ajouter au Panier';
...
Localization.spaBooking.serviceSelection.availabilityRow = '<div class="clearfix spaAvailability"> <i class="icon-time"></i> <button class="bookButton btn btn-primary pull-right">Reserve maintenant</button><span class="time"></div>';
// </span><span class="staff"></ span><small>(<span class="price"></ span>)</small>
